...
func TestTestUpstreamProxy_Success(t *testing.T) {
	...
	upstream, err := s.CreateUpstream("test-proxy-ok", fakeUpstream.URL, []string{"sk-test-key"}, 1, "", "round-robin", "api_key", "", false, false, 0)
	require.NoError(t, err)
...
func TestTestUpstreamProxy_UnreachableURL(t *testing.T) {
	...
	upstream, err := s.CreateUpstream("unreachable", "http://127.0.0.1:1", nil, 1, "", "round-robin", "api_key", "", false, false, 0)
	require.NoError(t, err)
...
func TestTestUpstreamProxy_Non2xx(t *testing.T) {
	...
	upstream, err := s.CreateUpstream("test-proxy-401", fakeUpstream.URL, []string{"sk-bad"}, 1, "", "round-robin", "api_key", "", false, false, 0)
	require.NoError(t, err)
...
func TestTestUpstreamProxy_NoAPIKey(t *testing.T) {
	...
	upstream, err := s.CreateUpstream("public", fakeUpstream.URL, nil, 1, "", "round-robin", "api_key", "", false, false, 0)
	require.NoError(t, err)
...
func TestCheckUpstreamQuota_Success(t *testing.T) {
	...
	upstream, err := s.CreateUpstream("quota-ok", fakeUpstream.URL, []string{"sk-quota-key"}, 1, "", "round-robin", "api_key", "", false, false, 0)
	require.NoError(t, err)
...
func TestCheckUpstreamQuota_NonNewAPI(t *testing.T) {
	...
	upstream, err := s.CreateUpstream("quota-noapi", fakeUpstream.URL, []string{"sk-key"}, 1, "", "round-robin", "api_key", "", false, false, 0)
	require.NoError(t, err)
...
func TestCheckUpstreamQuota_UpstreamHTTPError(t *testing.T) {
	...
	upstream, err := s.CreateUpstream("quota-500", fakeUpstream.URL, []string{"sk-key"}, 1, "", "round-robin", "api_key", "", false, false, 0)
	require.NoError(t, err)
...
func TestCheckUpstreamQuota_NonJSONContentType(t *testing.T) {
	...
	upstream, err := s.CreateUpstream("quota-html", fakeUpstream.URL, []string{"sk-key"}, 1, "", "round-robin", "api_key", "", false, false, 0)
	require.NoError(t, err)
...
func TestCheckUpstreamQuota_CodeFalse(t *testing.T) {
	...
	upstream, err := s.CreateUpstream("quota-code-false", fakeUpstream.URL, []string{"sk-key"}, 1, "", "round-robin", "api_key", "", false, false, 0)
	require.NoError(t, err)
...
func TestTestUpstreamAPIKey_OpenAI_Success(t *testing.T) {
	...
	upstream, err := s.CreateUpstream("test-key-openai", fakeUpstream.URL, []string{"sk-test-api-key"}, 1, "", "round-robin", "api_key", "", false, false, 0)
	require.NoError(t, err)
...
func TestTestUpstreamAPIKey_Anthropic_Success(t *testing.T) {
	...
	upstream, err := s.CreateUpstream("test-key-anthropic", fakeUpstream.URL, []string{"sk-anthropic-key"}, 1, "", "round-robin", "api_key", "", false, false, 0)
	require.NoError(t, err)
...
func TestTestUpstreamAPIKey_NotFoundKey(t *testing.T) {
	...
	upstream, err := s.CreateUpstream("test-key-notfound", "http://127.0.0.1:1", []string{"sk-key"}, 1, "", "round-robin", "api_key", "", false, false, 0)
	require.NoError(t, err)
...
func TestTestUpstreamAPIKey_OpenAI_ErrorResponse(t *testing.T) {
	...
	upstream, err := s.CreateUpstream("test-key-ratelimit", fakeUpstream.URL, []string{"sk-limited"}, 1, "", "round-robin", "api_key", "", false, false, 0)
	require.NoError(t, err)
...
func TestTestUpstreamAPIKey_DefaultProtocol(t *testing.T) {
	...
	upstream, err := s.CreateUpstream("test-default-proto", fakeUpstream.URL, []string{"sk-key"}, 1, "", "round-robin", "api_key", "", false, false, 0)
	require.NoError(t, err)
...
func TestTestUpstreamAPIKey_NoAuthKey(t *testing.T) {
	...
	upstream, err := s.CreateUpstream("test-no-auth", fakeUpstream.URL, nil, 1, "", "round-robin", "api_key", "", false, false, 0)
	require.NoError(t, err)
...
func TestTestUpstreamAPIKey_Unreachable(t *testing.T) {
	...
	upstream, err := s.CreateUpstream("test-key-unreachable", "http://127.0.0.1:1", []string{"sk-key"}, 1, "", "round-robin", "api_key", "", false, false, 0)
	require.NoError(t, err)
